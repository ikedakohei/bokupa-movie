    ...
    description: (
      <>
        ...
        <p>
          ...
          映画美学校第16期初等科フィクションコース卒業。
          大学卒業後は都内で会社員として勤務を続ける傍ら自主映画を製作。
          6年間務めた会社を退社し、映画美学校第10期アクターズコースに入学。
          主演を務めた短編映画『泥人』（2013）は、2014年調布映画祭グランプリを受賞した。
          また、監督作品に『凪』（2017）第一回渋谷TANPEN映画祭脚本賞助演女優賞・21st CHOFU SHORT FILM グランプリ・SKIPシティ国際映画祭入選。
          新作『ボクらのホームパーティー』（2022）は大阪アジアン映画祭2022・第30回レインボーリール東京に入選。
        </p>
      </>
    ),
