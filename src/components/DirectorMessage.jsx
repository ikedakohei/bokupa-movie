      ...
      <div className="mx-auto max-w-2xl lg:max-w-4xl lg:px-12">
        ...
        >
          <div className="flex justify-center">
            <h2 className="mb-4 px-2 pb-2 font-kaisei text-3xl font-bold tracking-tighter text-gray-900">
              監督よりご挨拶
            </h2>
          </div>
          <p className="mb-5">
          ...
          <p>
            ホームパーティ上で飛び交う彼らの目線の中に、どういった思惑・感情があるか、観客も一体となり、みんなで探っていけたら嬉しいです。
          </p>
        </div>
      </div>
    </Container>
